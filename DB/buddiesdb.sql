...
INSERT INTO `address` (`id`, `address`, `state`, `postal_code`, `city`, `enabled`) VALUES (21, '142 Main st', 'TX', '78701', 'Lansing', 1);
...
INSERT INTO `team` (`id`, `owner_id`, `content`, `image_url`, `name`, `create_date`, `enabled`) VALUES (2, 2, 'We are dedicated to cleaning up trash around town.', 'https://ibanplastic.com/wp-content/uploads/2018/05/Clean-The-World.jpg', 'Green Clean people machine', '2023-01-01', 1);
INSERT INTO `team` (`id`, `owner_id`, `content`, `image_url`, `name`, `create_date`, `enabled`) VALUES (3, 3, 'If you need a friend, we\'re here for you', 'https://www.healthyplace.com/sites/default/files/2020-11/making-friends-with-someone.jpg', 'Friend Finder', '2023-01-01', 1);
INSERT INTO `team` (`id`, `owner_id`, `content`, `image_url`, `name`, `create_date`, `enabled`) VALUES (4, 4, 'Healthy people healthy office', 'https://energyresourcing.com/wp-content/uploads/2022/07/man-making-a-plan-for-the-year-ahead.jpg', 'Work Life Balance', '2023-01-01', 1);
INSERT INTO `team` (`id`, `owner_id`, `content`, `image_url`, `name`, `create_date`, `enabled`) VALUES (5, 5, 'We are a videogame club', 'https://www.materacademybay.com/ourpages/auto/2019/9/5/38352958/gaming%20club-photo.jpg', 'Videogame Club', '2023-01-01', 1);
INSERT INTO `team` (`id`, `owner_id`, `content`, `image_url`, `name`, `create_date`, `enabled`) VALUES (6, 6, 'not the one you eat with soup', 'https://www.facebook.com/photo/?fbid=461481396029711&set=a.461481366029714', 'Frenchies', '2023-01-16', 1);
INSERT INTO `team` (`id`, `owner_id`, `content`, `image_url`, `name`, `create_date`, `enabled`) VALUES (7, 7, 'SOUP!!', 'https://www.happyfoodstube.com/wp-content/uploads/2016/04/spring-vegetable-soup-1.jpg', 'French Onion', '2023-01-18', 1);
INSERT INTO `team` (`id`, `owner_id`, `content`, `image_url`, `name`, `create_date`, `enabled`) VALUES (8, 8, 'Cronch Cronch Cronch!', 'https://assets-eu-01.kc-usercontent.com/559bb7d3-88a4-01c1-79a3-dd4d5b2d2bb0/b952b71e-20ff-4434-9486-5aa0b4378145/1-French-Baguettes.jpg?w=1920&q=85&auto=format&lossless=1', 'French Baguette', '2023-01-20', 1);
INSERT INTO `team` (`id`, `owner_id`, `content`, `image_url`, `name`, `create_date`, `enabled`) VALUES (9, 9, 'Carolina De Bilbao', 'https://ychef.files.bbci.co.uk/1600x900/p0bw7p4c.webp', 'Spain Spirals', '2023-01-22', 1);
INSERT INTO `team` (`id`, `owner_id`, `content`, `image_url`, `name`, `create_date`, `enabled`) VALUES (10, 10, 'Party Time', 'https://cdn.britannica.com/33/4233-050-3A1705E7/Flag-Zimbabwe.jpg', 'Zimbabwe Zanzibar', '2023-01-24', 1);
INSERT INTO `team` (`id`, `owner_id`, `content`, `image_url`, `name`, `create_date`, `enabled`) VALUES (11, 11, 'Better Party Time', 'https://st2.depositphotos.com/1074452/7714/i/450/depositphotos_77145159-stock-photo-afrikaans-word-indicates-study-language.jpg', 'Afrikaans Alakazams', '2023-01-26', 1);
INSERT INTO `team` (`id`, `owner_id`, `content`, `image_url`, `name`, `create_date`, `enabled`) VALUES (12, 12, 'Your one location of potato Information', 'https://food.fnr.sndimg.com/content/dam/images/food/fullset/2013/11/14/2/fnm_120113-potato-puffs-recipe_s4x3.jpg.rend.hgtvcom.826.620.suffix/1385047425933.jpeg', 'Potato Puff Pumpernickel', '2023-01-28', 1);
INSERT INTO `team` (`id`, `owner_id`, `content`, `image_url`, `name`, `create_date`, `enabled`) VALUES (13, 13, 'Join here if you want to win a clown', 'https://up-magazine.info/wp-content/uploads/2018/03/paparazzi.jpg', 'Plaza Prizes Paparazi', '2023-01-01', 1);
INSERT INTO `team` (`id`, `owner_id`, `content`, `image_url`, `name`, `create_date`, `enabled`) VALUES (14, 14, 'Our group knows the spot for the best pizza', 'https://www.foodandwine.com/thmb/4qg95tjf0mgdHqez5OLLYc0PNT4=/750x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/classic-cheese-pizza-FT-RECIPE0422-31a2c938fc2546c9a07b7011658cfd05.jpg', 'Pizza Pie Primates', '2023-01-12', 1);
INSERT INTO `team` (`id`, `owner_id`, `content`, `image_url`, `name`, `create_date`, `enabled`) VALUES (15, 15, 'We ripped off pringles', 'https://kellogg-h.assetsadobe.com/is/image/content/dam/kelloggs/kna/us/digital-shelf/pringles/00038000138652_D1CF_s01.jpg', 'Plump Prongles Plunger', '2023-01-14', 1);
INSERT INTO `team` (`id`, `owner_id`, `content`, `image_url`, `name`, `create_date`, `enabled`) VALUES (16, 16, 'Don\'t ask', 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/6f/Austin_Roberts-vo%C3%ABlreservaat%2C_dam_en_skuiling.jpg/800px-Austin_Roberts-vo%C3%ABlreservaat%2C_dam_en_skuiling.jpg?20120930091528', 'Skyline Chili Chuggers', '2023-01-16', 1);
INSERT INTO `team` (`id`, `owner_id`, `content`, `image_url`, `name`, `create_date`, `enabled`) VALUES (17, 17, 'wombat1', 'https://ca.slack-edge.com/T052X7BAZ-U052X7BBK-24590cb12c7e-512', 'Rob\'s Favorite Passwords', '2023-01-18', 1);
INSERT INTO `team` (`id`, `owner_id`, `content`, `image_url`, `name`, `create_date`, `enabled`) VALUES (18, 18, 'A group dedicated to the search of the Skill Distillery Dog', 'https://ca.slack-edge.com/T052X7BAZ-U718GEBK8-85e990aa8065-512', 'Skill Distillery Dog', '2023-01-20', 1);
INSERT INTO `team` (`id`, `owner_id`, `content`, `image_url`, `name`, `create_date`, `enabled`) VALUES (19, 19, 'I thought mars was red.', 'https://ca.slack-edge.com/T052X7BAZ-U718GEBK8-85e990aa8065-512', 'Blue Mars', '2023-01-22', 1);
INSERT INTO `team` (`id`, `owner_id`, `content`, `image_url`, `name`, `create_date`, `enabled`) VALUES (20, 20, 'forty-two', 'https://images.squarespace-cdn.com/content/v1/59932285c534a5589c0f696a/1502817144610-HEMH8XRLPYZ4IQU6AIKE/image1.PNG?format=1500w', 'The Meaning of Life', '2023-01-24', 1);
INSERT INTO `team` (`id`, `owner_id`, `content`, `image_url`, `name`, `create_date`, `enabled`) VALUES (21, 21, 'How can a bagel be everything?', 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/0d/20090424_Bagels_001.JPG/250px-20090424_Bagels_001.JPG', 'Everything Bagel', '2023-01-26', 1);
